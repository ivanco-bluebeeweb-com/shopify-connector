...
-- same pattern as MuleSoft Connector's / Power Automate Connector's /
n8n Connector's main.py.
"""
...
_LOCAL = ("app", "schemas", "shopify_client", "handlers", "panels", "panels_settings")
for _mod in _LOCAL:
